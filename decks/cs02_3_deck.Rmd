...
## Ebola power calculation
 ...
 Suppose, however, you could run a study in a town currently experiencing an epidemic, and that you expect 2\% of the population will contract Ebola, and again you are curious about whether the vaccine can cut that incidence rate in half.
...
Suppose we wish to test the efficacy of a tax on sugar drinks. How might we design and carry out the study?
