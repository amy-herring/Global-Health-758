...
If you miss class or would like to review the material covered in class, you can view the recordings [here](https://trinity.capture.duke.edu/Panopto/Pages/Sessions/List.aspx?folderID=9161c49e-b3d5-4d40-a282-ebe8a938055d). NEED TO UPDATE LINK Note that you will need to log in with your Net ID.
...
- Late work will not be accepted for the individual case study. Missed application exercises cannot be made up (the bottom 20% will be dropped).
